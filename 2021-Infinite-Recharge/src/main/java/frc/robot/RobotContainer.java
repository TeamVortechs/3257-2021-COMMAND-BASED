...
import frc.robot.commands.AlignToBezier;
import frc.robot.commands.DriveBezier;
...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        // Generated by 6644 Atomic Autonomous Tools - Java
        // Paste this into your Autonomous command group
        BezierCurve bezier1 = new BezierCurve(new Point2D.Double(2, -2),new Point2D.Double(2, 2),new Point2D.Double(4, 0));
        return new SequentialCommandGroup(
            new AlignToBezier(0.2, bezier1, 0, drivetrain),
            new DriveBezier(0.4, bezier1, false, drivetrain)
        );
    }
